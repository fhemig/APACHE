...
A documentação deste conjunto de dados está sendo feita de forma aberta e colaborativa no [Github](https://github.com/fhemig/APACHE). Existem duas alternativas para enviar sua contribuição:

- [Issues](https://github.com/fhemig/APACHE/issues): Para iniciar uma discussão sobre melhorias na documentação.
- [Pull requests](https://github.com/fhemig/APACHE/pulls): Para sugerir uma alteração concreta na documentação.
